<x-layouts.admin>
    ...
    <x-slot name="moreButtons">
        <x-dropdown id="dropdown-more-actions">
            ...
            <x-dropdown.link href="{{ route('payroll.pay-slips.print', $pay_slip->id) }}" target="_blank">
                {{ trans('general.print') }}
            </x-dropdown.link>
    
            <x-dropdown.link href="{{ route('payroll.pay-slips.pdf', $pay_slip->id) }}">
            ...
            <div class="lg:w-full lg:pl-12">
                <div class="print-content p-7 shadow-2xl rounded-2xl">
                    ...
                    <div class="row">
                        <div class="col-50">
                            <div class="text extra-spacing mr-6">
                                <table class="c-lines">
                                    <thead>
                                        <tr>
                                            <th class="text-left item text text-semibold pl-0">
                                                {{ trans_choice('payroll::general.benefits', 2) }}
                                            </th>
                                            <th class="total text text-semibold pr-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="item text pl-0">
                                                {{ trans_choice('payroll::general.salaries', 1) }}
                                            </td>
                                            <td class="total text pr-0">
                        ...
                        <div class="col-50">
                            <div class="text extra-spacing right-column ml-6">
                                <table class="c-lines">
                                    <thead>
                                        <tr>
                                            <th class="text-left item text text-semibold pl-0">
