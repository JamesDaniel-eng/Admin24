<x-form id="new_deduction_form" :route="['payroll.modals.employees.deduction.store', $employee->id]">
    <x-form.section>
        <x-slot name="body">
            ...
            <x-form.group.select name="recurring" label="{{ trans('payroll::general.recurring') }}" :options="$recurring" form-group-class="sm:col-span-6" change="toggleToDateFieldDeduction" />
