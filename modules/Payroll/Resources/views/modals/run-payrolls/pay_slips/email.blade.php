<x-form id="form-email" :route="['payroll.pay-calendars.run-payrolls.pay-slips.email.store', $payCalendar->id, $runPayroll->id, $employee->id]">
                ...
                <x-form.section>
                    <x-slot name="body">
                        <x-form.group.select
                            ...
                            :options="$employee->email ? [$employee->email]: []"
                            :selected="$employee->email ? [$employee->email]: []"
                            multiple
                            v-disabled
                    ...
                    <x-table.tbody>
                        <x-table.tr id="method-pdf">
                            ...
                            <x-table.td class="w-4/6">
                                {{ trans('general.pdf_file', ['type' => trans_choice('payroll::general.pay_slips', 1)]) }}
                            </x-table.td>
