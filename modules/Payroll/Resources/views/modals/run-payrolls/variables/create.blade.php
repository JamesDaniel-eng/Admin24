<x-form.container class="relative lg:w-full z-10" override="class">
    <x-form id="run-payroll" :route="['payroll.pay-calendars.run-payrolls.variables.store', $run_payroll->pay_calendar_id, $run_payroll->id]">
            ...
            <div class="lg:w-4/12 space-y-12">
                <x-form.section>
                    ...
                    <x-slot name="body">
                        ...
                        <x-form.input.hidden name="paycalendar_id" value="{{ $payCalendar->id }}" />
