...
class EmployeeDetailed extends Report
{
    ...
    {
        parent::setViews();
        $this->views['detail.table.footer'] = 'payroll::partials.reports.employee_detailed.detail.table.footer';
        $this->views['detail.table.row'] = 'payroll::partials.reports.employee_detailed.detail.table.row';
        $this->views['detail.table.header'] = 'payroll::partials.reports.employee_detailed.detail.table.header';
    }
    ...
    {
        $this->column_name_width = 'w-1/12 col-2';
        $this->column_value_width = 'w-2/12 col-2';
    }
