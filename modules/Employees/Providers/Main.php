...
class Main extends Provider
{
    ...
    {
        $replaceConfigs = ['search-string', 'custom-fields', 'setting'];
    ...
    public function registerDynamicRelations()
    {
        ...
        // Employee::resolveRelationUsing('dismissal', function ($employee) {
        //     return $employee->hasOne(Dismissal::class, 'employee_id', 'id');
        // });
    }
}
