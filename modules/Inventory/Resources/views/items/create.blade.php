<x-layouts.admin>
        ...
        <x-form.container>
            <x-form id="item" route="inventory.items.store">
                ...
                <x-form.section>
                    ...
                    <x-slot name="body">
                        <x-form.group.checkbox name="returnable" id="item-returnable" :options="['1' => trans('inventory::general.returnable')]" @input="onCanReturnable($event)" form-group-class="sm:col-span-2" checkbox-class="sm:col-span-6" />
    ...
    @push('scripts_start')
        <script type="text/javascript">
            ...
            var inventory_items = {!! json_encode([]) !!};
