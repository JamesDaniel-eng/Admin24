...
return [
    ...
    'pot_text' => [
        ...
        'create_transfer_desc'  => 'Move items TO the production site to create a transfer order.',
        'create_return_desc'    => 'Move items FROM the production site to create a reverse transfer order.',
    ],
