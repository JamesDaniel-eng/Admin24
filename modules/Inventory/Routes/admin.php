...
Route::admin('inventory', function () {
    ...
    Route::get('items/get-barcode', 'Items@getBarcode')->name('items.get-barcode');
    ...
    Route::post('transfer-orders/import', 'TransferOrders@import')->name('transfer-orders.import');
    Route::get('transfer-orders/export', 'TransferOrders@export')->name('transfer-orders.export');
    ...
    Route::get('pot/get-warehouse-items', 'Pot@getWarehouseItems')->name('pot.get-warehouse-items');
    Route::resource('pot', 'Pot');
    ...
    //Settings
    Route::get('settings/example-barcode', 'Settings@exampleBarcode')->name('settings.example-barcode');
