<x-layouts.admin>
    ...
    <x-slot name="moreButtons">
        <x-dropdown id="dropdown-more-actions">
            ...
            @can('create-inventory-transfer-orders')
                <x-dropdown.link href="{{ route('import.create', ['admin24', 'transfer-orders']) }}">
                    {{ trans('import.import') }}
                </x-dropdown.link>
            @endcan
    ...
    <x-slot name="content">
        ...
        @else
            <x-empty-page group="inventory" page="transfer-orders" docs-category="admin24" title="{{ trans_choice('admin24::general.transfer_orders', 1) }}" />
        @endif
    </x-slot>
