...
use Modules\DoubleEntry\Exports\JournalEntry\Sheets\ChartOfAccounts;
...
use Modules\DoubleEntry\Exports\JournalEntry\Sheets\Transactions;
use Modules\DoubleEntry\Exports\JournalEntry\Sheets\Accounts;
...
class Journals implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        return [
            ...
            new Transactions($this->ids),
            new ChartOfAccounts($this->ids),
