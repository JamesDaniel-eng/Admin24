    ...
    public function get($model, $key, $value, $attributes)
    {
        ...
        switch (get_class($model->ledgerable)) {
            ...
            case 'App\Models\Document\DocumentTotal':
                ...
                break;
            case 'App\Models\Banking\TransactionTax':
                $model->ledgerable->load('transaction');

                $value = $this->convertToDefault($value ?? 0, $model->ledgerable->transaction->currency_code ?? setting('default.currency'), $model->ledgerable->transaction->currency_rate ?? 1);
