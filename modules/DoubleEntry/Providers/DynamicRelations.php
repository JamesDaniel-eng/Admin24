    ...
    public function register()
    {
        Document::resolveRelationUsing('de_ledger', function ($document) {
            if ($document instanceof \Modules\CreditDebitNotes\Models\CreditNote 
                ...
                || $document instanceof \Modules\Expenses\Models\ExpenseClaim
                ) {
        ...
        Document::resolveRelationUsing('de_recur_ledger', function ($document) {
            return $document->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });
        ...
        DocumentItem::resolveRelationUsing('de_recur_ledger', function ($documentItem) {
            return $documentItem->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });
        ...
        DocumentItemTax::resolveRelationUsing('de_recur_ledger', function ($documentItemTax) {
            return $documentItemTax->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });
        ...
        DocumentTotal::resolveRelationUsing('de_recur_ledger', function ($documentTotal) {
            return $documentTotal->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });

        Transaction::resolveRelationUsing('journal_ledger', function ($transaction) {
            return $transaction->belongsTo('Modules\DoubleEntry\Models\Ledger', 'id', 'transaction_id');
        });
        ...
        Transaction::resolveRelationUsing('de_recur_ledger', function ($transaction) {
            return $transaction->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });

        TransactionTax::resolveRelationUsing('de_ledger', function ($transaction) {
            return $transaction->morphOne('Modules\DoubleEntry\Models\Ledger', 'ledgerable');
        });

        TransactionTax::resolveRelationUsing('de_recur_ledger', function ($transaction) {
            return $transaction->morphOne('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });
        ...
        Transaction::resolveRelationUsing('recur_ledgers', function ($transaction) {
            return $transaction->morphMany('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });

        TransactionTax::resolveRelationUsing('ledgers', function ($transactionTax) {
            return $transactionTax->morphMany('Modules\DoubleEntry\Models\Ledger', 'ledgerable');
        });

        TransactionTax::resolveRelationUsing('recur_ledgers', function ($transactionTax) {
            return $transactionTax->morphMany('Modules\DoubleEntry\Models\RecurringLedger', 'ledgerable');
        });
        ...
        Account::resolveRelationUsing('de_bank_account', function ($account) {
            return $account->belongsTo('Modules\DoubleEntry\Models\AccountBank', 'id', 'bank_id');
        });

        Tax::resolveRelationUsing('de_tax', function ($tax) {
            return $tax->belongsTo('Modules\DoubleEntry\Models\AccountTax', 'id', 'tax_id');
        });
    }
