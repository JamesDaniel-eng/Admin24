...
use Modules\DoubleEntry\Exports\ChartOfAccount\ChartOfAccounts as Export;
use Modules\DoubleEntry\Imports\ChartOfAccount\ChartOfAccounts as Import;
...
class ChartOfAccounts extends Controller
{
    ...
    {
        $response = $this->importExcel(new Import, $request, trans_choice('double-entry::general.chart_of_accounts', 2));
