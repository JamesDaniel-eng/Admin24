...
<div class="container flex items-center py-3 mb-4 border-b-2 xl:hidden">
    ...
    <img src="{{ asset('public/img/admin-24-logo-emblem.svg') }}" class="w-8 m-auto" alt="Akaunting" />
...
>
        ...
        <div class="relative mb-5 cursor-pointer">
            <button type="button" class="flex items-center" data-dropdown-toggle="dropdown-menu-company">
                <div class="w-8 h-8 flex items-center justify-center">
                    <img src="{{ asset('public/img/admin-24-logo-emblem.svg') }}" class="w-6 h-6" alt="Akaunting" />
                </div>
    ...
    {{-- Notifications panel removed from sidebar by customization --}}
    {{--
        Add a small, hidden stub so legacy JS that queries notification DOM nodes
        doesn't throw when the visible UI was removed. This keeps runtime fixes
        minimal and avoids editing compiled/minified JS bundles.
    --}}
    <div style="display:none" data-menu="notifications-menu" class="notifications-menu user-menu">
        <!-- Minimal IDs/attributes referenced by scripts -->
        <span id="menu-notification-icon" data-notification-count></span>
