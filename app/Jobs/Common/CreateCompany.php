...
class CreateCompany extends Job implements HasOwner, HasSource, ShouldCreate
{
    ...
    public function handle(): Company
    {
        ...
        \DB::transaction(function () {
            ...
            // Activate modules for new companies. [Admin24 Enhancement]
    ...
    /** 
     * Activate the Admin24 Module for
     * every new company that is created.
     * [Admin24 Enhancement]
     */
    ...
    {
        /**
         * Fetch all modules and activate them for the new company.
         * [Admin24 Enhancement]
         */
        
        $modules = Module::where('company_id', 1)->get();
